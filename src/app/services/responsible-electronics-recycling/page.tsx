...
export default function ResponsibleElectronicsRecycling() {
  ...
  const structuredData = {
    ...
    offers: {
      "@type": "Offer",
      description:
        "Environmentally responsible electronics recycling with zero landfill guarantee",
    },
  };
        ...
        <div className="relative z-[1] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto mb-6 sm:mb-8 px-2">
              <strong>
                R2 v3 certified electronics recycling with zero landfill
                guarantee and 95%+ material recovery throughout Georgia and
                Southeast States.
              </strong>
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                <strong>
                  Our R2 v3 certified facility ensures environmentally
                  responsible recycling of all electronic equipment using
                  industry-leading processes that minimize environmental impact
                  while maximizing material recovery throughout Georgia and
                  Southeast States.
                </strong>
              </p>
          ...
          <div className="mb-16 bg-gray-50 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-primary-green">
                ...
                <p className="text-gray-600">
                  We recover and reuse 95% or more of all materials from
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-primary-green">
                ...
                <p className="text-gray-600">
                  Absolutely nothing goes to landfills - everything is reused or
                  recycled
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-primary-green">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-primary-green transition-all duration-300">
                ...
                <p className="text-gray-600">
                  ...
                  hazardous materials that can contaminate soil and groundwater
              ...
              <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-primary-green transition-all duration-300">
                ...
                <p className="text-gray-600">
                  Recycling electronics recovers precious metals like gold,
                  silver, and copper, reducing the need for environmentally
              ...
              <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-primary-green transition-all duration-300">
                ...
                <p className="text-gray-600">
                  Materials from old electronics become raw materials for new
                  products, creating a sustainable cycle that benefits the
                  entire economy.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-primary-green transition-all duration-300">
                ...
                <p className="text-gray-600">
                  Recycling uses significantly less energy than mining and
                  manufacturing from raw materials, dramatically reducing
              ...
              <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-primary-green transition-all duration-300">
                ...
                <p className="text-gray-600">
                  Many states and localities require proper electronics
                  disposal. Our certified processes ensure you meet all
              ...
              <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-primary-green transition-all duration-300">
                ...
                <p className="text-gray-600">
                  Responsible recycling today ensures cleaner air, water, and
                  soil for our children and grandchildren to inherit.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16 bg-gray-50 rounded-2xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Every step of our process is designed to maximize material
                recovery while ensuring complete environmental protection.
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      All data-bearing devices undergo complete data destruction
                      before processing
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Devices are carefully disassembled to separate different
                      material types
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Materials are processed using advanced techniques to
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Rigorous quality checks ensure all materials meet
                      recycling standards
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Processed materials are sent to certified downstream
                      partners for reuse
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Comprehensive reports show exactly how your equipment was
                      processed and its environmental benefit
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center bg-primary-green rounded-2xl p-8 text-white">
            ...
            <p className="text-xl mb-8 text-gray-100">
              Contact Computer Recyclers USA today to schedule your electronics
              recycling pickup in Georgia
            </p>
