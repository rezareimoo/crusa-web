            ...
            <div className="flex items-center space-x-4">
              {currentStep < totalSteps ? (
                ...
                <button
                  ...
                  className="bg-primary-green hover:bg-primary-green-dark text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:bg-primary-green flex items-center justify-center min-w-[180px]"
                >
                  {isSubmitting ? (
                    <>
                      <svg 
