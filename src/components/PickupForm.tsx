  ...
  return (
    <div className="bg-gray-100 rounded-2xl shadow-2xl overflow-hidden max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Schedule Free Pickup</h2>
      ...
      {submitStatus === "success" && (
        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          <div className="flex items-center">
            ...
            <p className="text-green-700 font-medium">Thank you! Your pickup request has been submitted successfully.</p>
          </div>
        </div>
      )}
